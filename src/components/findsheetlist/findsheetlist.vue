<template>
  <div class="findsheetlist" :style="{width:listwidth,padding:listpadding}">
    <div class="content">
      ...
      <span class="toprighttips" v-show="showtoprighttips"><i class="icon" :class="toprighticonclass"></i>{{formartTopRight}}</span>
      <span class="bottomtips" v-show="showbottomtips">{{bottomtips}}</span>
    </div>
    <div class="title" v-show="showbottomtitle">{{bottomtitle}}</div>
  </div>
</template>
<script>
  export default {
