      ...
      <div class="imagecontent">
        ...
        <div class="detail">
          ...
          <div class="tips">
            ...
            <span v-if="sheetData.tips" class="span-tips" v-for="(item,index) in sheetData.tips" :key="index">{{item}}</span>
          </div>
        </div>
      </div>
      <div class="bottom">
